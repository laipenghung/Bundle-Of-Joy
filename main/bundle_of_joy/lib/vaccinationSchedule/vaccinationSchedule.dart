...
class _VaccinationSchedule extends State<VaccinationSchedule> {
  ...
  Widget hasData(AsyncSnapshot<QuerySnapshot> collection){
    ...
    double paddingTopBottom = MediaQuery.of(context).size.height * 0.05;
  ...
  Widget build(BuildContext context) {
    ...
    Query vaccination = FirebaseFirestore.instance.collection("mother").doc(user.uid)
        .collection("baby").doc(selectedBabyID)
        .collection("baby_vaccination").where("bv_dateGiven", isGreaterThan: "")
