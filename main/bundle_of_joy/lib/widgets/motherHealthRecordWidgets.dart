...
class HealthRecordPregnancyWidget extends StatelessWidget {
  ...
  const HealthRecordPregnancyWidget({Key key, @required this.svgSrcDate, @required this.dayOfPregnancy, @required this.recordDate, @required this.svgSrcDatePreg
