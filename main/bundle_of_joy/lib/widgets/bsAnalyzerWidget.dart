...
class BloodSugarAnalyzerWidget extends StatelessWidget {
  ...
  const BloodSugarAnalyzerWidget({
    Key key, this.svgSrc, this.bSugarBefore, this.bSugarAfter,
  }) : super(key: key);
              ...
              Container(
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      TextSpan(
                        text: "If you wish to learn more on how BoJ Analyzer™ use the blood glucose reading you provided to analyze your blood glucose condition." +
                          " You can ",
                      ),
                      TextSpan(
                        text: "tap here",
