...
import 'package:bundle_of_joy/widgets/tipsScreens/Bp_Tips.dart';
...
class HealthRecordBloodPressureAnalyzer extends StatelessWidget {
  ...
  const HealthRecordBloodPressureAnalyzer({
    ...
    @required this.bPressureSystolic,
    @required this.bPressureDiastolic,
  }) : super(key: key);
    ...
    return Column(
      children: <Widget>[
        ...
        Container(
          ...
          child: Text(
            "BoJ Analyzer™ will provide you feedback on condition of your Blood Pressure based on the your " + "Blood Pressure reading saved on our database.",
        ...
        HealthRecordBloodPressureChart(
          chartData: chartData,
        ),
        Container(
          child: Column(
              ...
              Container(
                ...
                child: RichText(
                    ...
                    text: TextSpan(style: normalTextStye, children: <TextSpan>[
                      TextSpan(
                        text: "If you wish to learn more on how BoJ Analyzer™ use your blood pressure reading saved on the database " + "to analyze your blood pressure condition. You can ",
                      ),
                      TextSpan(
                          text: "tap here",
                          style: linkTextStyle,
