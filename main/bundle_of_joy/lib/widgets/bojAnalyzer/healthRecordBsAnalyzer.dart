...
class HealthRecordBloodSugarAnalyzer extends StatelessWidget {
  ...
  const HealthRecordBloodSugarAnalyzer({
    Key key, @required this.svgSrc, @required  this.bSugarReading,
  }) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          HealthRecordBloodSugarChart(chartData: chartData,),
          Container(
            child: Column(
              children: <Widget>[
                Container(
                ...
                Container(
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                          text: "If you wish to learn more on how BoJ Analyzer™ use your blood glucose reading saved on the database " +
                            "to analyze your blood glucose condition. You can ",
                        ),
                        TextSpan(
                          text: "tap here",
                          style: linkTextStyle,
...
class HealthRecordBloodSugarChartData{
  ...
  HealthRecordBloodSugarChartData({
    @required this.period, @required this.bsReading, @required  this.barColour,}
  );
}