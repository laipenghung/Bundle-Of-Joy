...
class BabyGrowthWidget extends StatefulWidget {
  final String graphTitle, graphDesc, svgSrcGraph, tableTitle, tableDesc, svgSrcTable, listFirstElement, xAxisLabel, yAxisLabel, measurement, tableMeasurement;
  ...
  BabyGrowthWidget(
      ...
      @required this.graphDesc,
      @required this.tableTitle,
      @required this.tableDesc,
      @required this.svgSrcGraph,
      @required this.svgSrcTable,
      @required this.chartData,
      @required this.listFirstElement,
      @required this.ageListInt,
      @required this.growthValueList,
      @required this.xAxisLabel,
      @required this.yAxisLabel,
      @required this.measurement,
      @required this.tableMeasurement,
      @required this.growthTrack})
      : super(key: key);
