                ...
                InkWell(
                  ...
                  onTap: () {
                    if(medsMap.isEmpty){
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => BabyTempAdd2(selectedDate: widget.selectedDate, 
                          selectedTime: widget.selectedTime, selectedBabyID: widget.selectedBabyID, medsMap: medsMap)),
                      );
