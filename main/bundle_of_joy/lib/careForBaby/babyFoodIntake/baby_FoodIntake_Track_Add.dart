...
import 'package:bundle_of_joy/careForBaby/babyFoodIntake/baby_FoodIntake_Track_Add_Summary.dart';
    ...
    return Column(
      children: <Widget>[
        Container(
          ...
          child: Text(
            "If you want to update the after meal behavior, you can toogle switch one the top right corner. " + "You can upload the current food record as the complete record or upload it as pending record.",
            textAlign: TextAlign.left,
            style: TextStyle(
              fontSize: MediaQuery.of(context).size.width * 0.035,
              color: Colors.black.withOpacity(0.65),
