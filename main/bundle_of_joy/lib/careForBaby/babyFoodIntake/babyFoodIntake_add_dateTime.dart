...
import 'babyFoodIntake_add_food.dart';

class BabyFoodIntakeAdd1 extends StatefulWidget {
  final String selectedBabyID;
  BabyFoodIntakeAdd1({Key key, this.selectedBabyID}) : super(key: key);

  @override
  _BabyFoodIntakeAdd1State createState() => _BabyFoodIntakeAdd1State();
}

class _BabyFoodIntakeAdd1State extends State<BabyFoodIntakeAdd1> {
  // Variables
  DateTime pickedDate;
  TimeOfDay time;
